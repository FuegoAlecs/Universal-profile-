...
export default function ProfileCard() {
  // Removed address prop
  const params = useParams()
  const address = params.address as string // Get address from URL params
  ...
  const { data: tokenBalances, isLoading: tokenBalancesLoading } = useAlchemyTokenBalances(address || "")
